...
CUSTOM_ID = 13
# 标签值表文件路径
TAG_FILE_PATH = 'C:/Users/Ben/Desktop/fcmp/数据_量子健康/【量子健康】标签值表-标签规则-v6.5 - 0611.csv'
# 用户标签表、用户中间值表、用户下载表名
...
tl_pre_001 = '''\
-- 合并多张销售月表为一张销售总表
drop table if exists order_list1;
...
union all select * from order_list_201804
union all select * from order_list_201805
union all select * from order_list_201806
union all select * from order_list_201807
union all select * from order_list_201808
union all select * from order_list_201809
union all select * from order_list_201810
union all select * from order_list_201811
union all select * from order_list_201812
union all select * from order_list_201901
union all select * from order_list_201902
union all select * from order_list_201903
union all select * from order_list_201904
union all select * from order_list_201905;

alter table order_list1 add column member_group int(2) default 1 comment '订单所属的数据批次';

drop table if exists order_list2;
create table order_list2
          select * from order_list2_201801
union all select * from order_list2_201802
union all select * from order_list2_201803
union all select * from order_list2_201804
union all select * from order_list2_201805
union all select * from order_list2_201806
union all select * from order_list2_201807
union all select * from order_list2_201808
union all select * from order_list2_201809
union all select * from order_list2_201810
union all select * from order_list2_201811
union all select * from order_list2_201812
union all select * from order_list2_201901
union all select * from order_list2_201902
union all select * from order_list2_201903
union all select * from order_list2_201904
union all select * from order_list2_201905;

alter table order_list2 add column member_group int(2) default 2 comment '订单所属的数据批次';


drop table if exists order_list;
create table order_list
          select * from order_list1
union all select * from order_list2;
...
update member_info set province = '四川省' where province = '四川';
update member_info set province = '海南省' where province = '南海省';
update member_info set province = '广西壮族自治区' where province = '广西省';
