...
on u_tag_13.phone = member_info.phone
set u_tag_13.t_u_age = 
case
when member_info.age <= 17 then 1
when member_info.age >= 18 and member_info.age <= 23 then 2
when member_info.age >= 24 and member_info.age <= 27 then 3
when member_info.age >= 28 and member_info.age <= 30 then 4
when member_info.age >= 31 and member_info.age <= 35 then 5
when member_info.age >= 36 and member_info.age <= 40 then 6
when member_info.age >= 41 and member_info.age <= 45 then 7
when member_info.age >= 46 and member_info.age <= 50 then 8
when member_info.age >= 51 and member_info.age <= 55 then 9
when member_info.age >= 56 and member_info.age <= 60 then 10
when member_info.age >= 61 and member_info.age <= 65 then 11
when member_info.age >= 66 and member_info.age <= 70 then 12
when member_info.age >= 71 then 13
else 0 end;
...
where order_list.order_time < date_sub(date(20180312),interval 3 month)
...
inner join order_list 
on u_mid_13.phone = order_list.phone
where order_list.order_time >= date_sub(date(20180312),interval 12 month)
group by u_mid_13.id
) y on x.id = y.id 
...
left join u_mid_13 
on u_tag_13.id = u_mid_13.id
set u_tag_13.t_u_valuable = 
case
when u_mid_13.order_times_total > 5 and u_mid_13.total_cost_value > 500 then 1
else 0 end;

-- b_3001_mid_type2_basic
-- 过程值：首次到店日期
alter table u_mid_13 add column first_come_date date default null comment '过程值：首次到店日期';

update u_mid_13 x inner join (
select u_mid_13.id, min(order_list.order_time) c from 
u_mid_13 
inner join order_list 
on u_mid_13.phone = order_list.phone
where true
...
-- 过程值：近一年到店计入月数
alter table u_mid_13 add column t_u_last_year_interview_month decimal(7,5) default 0.0 comment '过程值：近一年到店计入月数';

update u_mid_13 
set u_mid_13.t_u_last_year_interview_month = 
case
...
left join u_mid_13 
on u_tag_13.id = u_mid_13.id
set u_tag_13.t_u_year_frequency = 
case
when u_mid_13.last_year_rate <= 0.25 then 0
when u_mid_13.last_year_rate >= 0.25 and u_mid_13.last_year_rate <= 0.5 then 1
when u_mid_13.last_year_rate >= 0.5 then 2
else 0 end;
...
left join u_mid_13 
on u_tag_13.id = u_mid_13.id
set u_tag_13.t_u_total_order = 
case
when u_mid_13.order_times_total <= 1 then 0
when u_mid_13.order_times_total >= 2 and u_mid_13.order_times_total <= 4 then 1
when u_mid_13.order_times_total >= 5 and u_mid_13.order_times_total <= 7 then 2
when u_mid_13.order_times_total >= 8 and u_mid_13.order_times_total <= 10 then 3
when u_mid_13.order_times_total >= 11 and u_mid_13.order_times_total <= 15 then 4
when u_mid_13.order_times_total >= 16 then 5
else 0 end;
...
left join u_mid_13 
on u_tag_13.id = u_mid_13.id
set u_tag_13.t_u_total_cost = 
case
when u_mid_13.total_cost_value <= 50 then 0
when u_mid_13.total_cost_value >= 50 and u_mid_13.total_cost_value <= 100 then 1
when u_mid_13.total_cost_value >= 100 and u_mid_13.total_cost_value <= 200 then 2
when u_mid_13.total_cost_value >= 200 and u_mid_13.total_cost_value <= 500 then 3
when u_mid_13.total_cost_value >= 500 and u_mid_13.total_cost_value <= 1000 then 4
when u_mid_13.total_cost_value >= 1000 then 5
else 0 end;
...
update u_mid_13 
set u_mid_13.per_customer_transaction = total_cost_value/order_times_total
where true;
...
left join u_mid_13 
on u_tag_13.id = u_mid_13.id
set u_tag_13.t_u_pct = 
case
when u_mid_13.per_customer_transaction <= 50 then 0
when u_mid_13.per_customer_transaction >= 50 and u_mid_13.per_customer_transaction <= 100 then 1
when u_mid_13.per_customer_transaction >= 100 and u_mid_13.per_customer_transaction <= 200 then 2
when u_mid_13.per_customer_transaction >= 200 and u_mid_13.per_customer_transaction <= 500 then 3
when u_mid_13.per_customer_transaction >= 500 and u_mid_13.per_customer_transaction <= 1000 then 4
when u_mid_13.per_customer_transaction >= 1000 then 5
else 0 end;
...
-- 物流偏好-其他
alter table u_tag_13 add column t_u_ex_pref_11 int(5) default 0 comment '物流偏好-其他';

update u_tag_13 
set u_tag_13.t_u_ex_pref_11 = 1
...
-- b_2001_tag_type1_where
-- 产品偏好-其他
alter table u_tag_13 add column t_u_product_pref_21 int(5) default 0 comment '产品偏好-其他';

update u_tag_13 
set u_tag_13.t_u_product_pref_21 = 1
